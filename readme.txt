...
Add the following lines to your crontab 'crontab -e' to have the script download a snapshot every 15 minutes between the hours of 
UTC20-23 & UTC0-5 (NZST 8AM-5PM)
...
*/15 20-23 * * * cd ~/<foldername>/ && python3 snapshot.py
